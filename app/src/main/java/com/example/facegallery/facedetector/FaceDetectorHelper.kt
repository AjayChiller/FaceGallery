...
package com.example.facegallery.facedetector
...
class FaceDetectorHelper(
    ...
    fun detectImage(image: Bitmap): ResultBundle? {
        ...
        if (runningMode != RunningMode.IMAGE) {
            throw IllegalArgumentException(
                "DDDD Attempting to call detectImage" +
                        " while not using RunningMode.IMAGE"
            )
        }

        Log.e("DDDDD","face det "+( (faceDetector == null) ))
    ...
    companion object {
        ...
        const val THRESHOLD_DEFAULT = 0.7F
